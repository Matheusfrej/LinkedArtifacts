...
export default function GitHubTable({ data }: GitHubTableProps) {
  ...
  return (
    <BaseRepositoryTable
      title="GitHub"
      description="Table with GitHub artifacts from paper with associated metadata"
      icon={
        // GitHub icon is deprecated in lucide-react lib
        <svg className="h-5 w-5 text-foreground/70" viewBox="0 0 24 24" fill="currentColor">
