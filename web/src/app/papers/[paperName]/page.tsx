...
import FigshareTable, { type FigshareArtifact } from "./components/FigshareTable"
import OtherRepositoriesTable, { type OtherRepository } from "./components/OtherRepositoriesTable"
  ...
  return (
    <div className="py-8 space-y-8 max-w-6xl mx-auto px-4">
      <div className="space-y-2">
        <h1 className="text-3xl font-bold text-foreground">{decodedPaperName}</h1>
        ...
        mockOtherRepositories.length === 0 && (
          <div className="bg-background border border-foreground/20 rounded-lg shadow-sm">
            <div className="py-12 text-center">
              <p className="text-foreground/60">No artifacts found for this paper.</p>
            </div>
          </div>
        )}
    </div>
